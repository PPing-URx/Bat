async function fetchTemperatureData() {
    const response = await fetch(
        'https://sheets.googleapis.com/v4/spreadsheets/1Rcu-B8b9ZLW67eSutCG2f-_y0Ar1PL_Xo2spWAiFRQM/values/Sheet1!A2:C?key=AIzaSyAoApzYIbKdNxPmVKwihgcnzP-xjAQXS4c'
    );
